            ...
            >
              ...
              <div className="relative">
                ...
                {isActive && !isCompleted && (
                  <div className="absolute inset-0 -m-2">
                    <div className="w-14 h-14 rounded-full bg-blue-500/20 animate-ping" />
                  </div>
                )}
                ...
                <div className={cn(
                  ...
                  isCompleted && "bg-gradient-to-br from-green-500 to-green-600 border-green-500 text-white shadow-lg shadow-green-500/30",
                  isActive && !isCompleted && "bg-gradient-to-br from-blue-500 to-purple-500 border-blue-500 text-white shadow-lg shadow-blue-500/30",
                ...
                {!isCompleted && !isActive && (
                  <div className="absolute -top-1 -right-1 w-4 h-4 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
              ...
              <div className="mt-3 text-center">
                <p className={cn(
                  ...
                  isActive && !isCompleted && "text-blue-600 dark:text-blue-400",
